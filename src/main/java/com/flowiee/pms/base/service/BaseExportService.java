...
public abstract class BaseExportService extends BaseService implements ExportService {
    ...
    protected void createDropdownList(List<String> pListValue, int pRowSelectionBegin, int pRowSelectionEnd, int pColumnIndex, String pNameName) {
        ExcelUtils.createDropdownList(mvWorkbook, mvDataSheet, mvCategoriesHiddenSheet, pListValue, pRowSelectionBegin, pRowSelectionEnd, pColumnIndex, pNameName);
    }
