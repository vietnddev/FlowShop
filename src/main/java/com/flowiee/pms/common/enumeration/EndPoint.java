...
public enum EndPoint {
    ...
    URL_STG_TICKET_IMPORT("/stg/transaction-goods/import", "SIDEBAR", true),
    URL_STG_TICKET_EXPORT("/stg/transaction-goods/export", "SIDEBAR", true),
    URL_SYS_CONFIG("/sys/config", "SIDEBAR", true),
    URL_SYS_LANGUAGES("/sys/language", "SIDEBAR", true),
