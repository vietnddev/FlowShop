...
public class TransactionGoodsControllerView extends BaseController {
    ...
    public ModelAndView displayTransactionDetail(@PathVariable("id") Long pTranId) {
        TransactionGoodsDTO transactionGoods = transactionGoodsService.findDtoById(pTranId, true);
