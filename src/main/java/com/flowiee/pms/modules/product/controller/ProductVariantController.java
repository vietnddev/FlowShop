...
import com.flowiee.pms.modules.product.service.ProductPriceService;
...
public class ProductVariantController extends BaseController {
    ...
    public AppResponse<List<ProductVariantDTO>> findVariantsOfProduct(@PathVariable("productId") Long productId) {
        return mvCHelper.success(mvProductVariantService.findAll(-1, -1, null, productId, null, null, null, null, null, null, false).getContent());
    }
    ...
    public AppResponse<String> updatePrice(@PathVariable("productVariantId") Long productVariantId,
        ...
        try {
            ...
            return mvCHelper.success(mvProductPriceService.updateProductPrice(productVariantId, originalPrice, discountPrice));
        } catch (RuntimeException ex) {
    ...
    public AppResponse<Boolean> checkProductVariantAlreadyExists(@RequestParam("productId") Long productId,
        ...
        try {
            return mvCHelper.success(mvProductVariantService.isProductVariantExists(productId, colorId, sizeId, fabricTypeId));
        } catch (RuntimeException ex) {
