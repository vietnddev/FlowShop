...
public class OrderDTO implements Serializable {
	...
	public static OrderDTO toDto(Order pOrder) {
        ...
        TransactionGoods lvTransactionGoodsExport = pOrder.getTransactionGoodsExport();
		...
		dto.setTicketExportId(lvTransactionGoodsExport != null ? lvTransactionGoodsExport.getId() : null);
