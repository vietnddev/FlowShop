...
public class CustomerServiceImpl extends BaseGService<Customer, CustomerDTO, CustomerRepository> implements CustomerService {
    ...
    private void setContactDefault(List<CustomerDTO> customerDTOs) {
        for (CustomerDTO c : customerDTOs) {
            CustomerContactDTO phoneDefault = mvCustomerContactService.findContactPhoneUseDefault(c.getId());
            CustomerContactDTO emailDefault = mvCustomerContactService.findContactEmailUseDefault(c.getId());
            CustomerContactDTO addressDefault = mvCustomerContactService.findContactAddressUseDefault(c.getId());
