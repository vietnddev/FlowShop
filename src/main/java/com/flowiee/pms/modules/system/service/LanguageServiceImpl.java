...
@Service
public class LanguageServiceImpl extends BaseGService<Language, LanguageDTO, LanguagesRepository> implements LanguageService {
	...
	public LanguageDTO findById(Long langId, boolean pThrowException) {
		return super.findById(langId, pThrowException);
	}
