...
@Service
public class NotificationServiceImpl extends BaseGService<Notification, NotificationDTO, NotificationRepository> implements NotificationService {
    ...
    public NotificationDTO findById(Long pNotificationId, boolean pThrowException) {
        return super.findById(pNotificationId, pThrowException);
    }
