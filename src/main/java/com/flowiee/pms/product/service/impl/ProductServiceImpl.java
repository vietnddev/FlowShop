...
@Slf4j
@Service
public class ProductServiceImpl extends BaseService<Product, ProductDTO, ProductRepository> implements ProductService {
    ...
    public ProductServiceImpl(ProductRepository pProductRepository, ProductDescriptionRepository pProductDescriptionRepository, ProductAttributeService pProductAttributeService, ProductDetailRepository pProductDetailRepository, @Lazy ProductVariantService pProductVariantService, ProductHistoryService pProductHistoryService, FileStorageRepository pFileStorageRepository, ProductPriceService pProductPriceService, SystemLogService pSystemLogService, OrderRepository pOrderRepository, CategoryService pCategoryService) {
