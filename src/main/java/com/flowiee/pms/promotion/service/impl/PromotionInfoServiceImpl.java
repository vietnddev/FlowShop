...
import com.flowiee.pms.promotion.service.PromotionApplyService;
import com.flowiee.pms.promotion.service.PromotionService;
import com.flowiee.pms.promotion.entity.PromotionInfo;
...
import com.flowiee.pms.promotion.repository.PromotionInfoRepository;
import com.flowiee.pms.shared.exception.*;
...
import com.flowiee.pms.promotion.enums.PromotionStatus;
    ...
    public Page<PromotionInfoDTO> findAll(int pageSize, int pageNum, String pTitle, LocalDateTime pStartTime, LocalDateTime pEndTime, String pStatus) {
        ...
        for (PromotionInfoDTO p : promotionInfoDTOs) {
            ...
            for (PromotionApplyDTO promotionApplyDTO : mvPromotionApplyService.findByPromotionId(p.getId())) {
                ProductDTO productDTOOptional = mvProductService.findById(promotionApplyDTO.getProductId(), false);
    ...
    public PromotionInfoDTO save(PromotionInfoDTO promotionInfoDTO) {
        ...
        try {
            ...
            for (ProductDTO product : promotionInfoDTO.getApplicableProducts()) {
                mvProductService.findById(product.getId(), true);
