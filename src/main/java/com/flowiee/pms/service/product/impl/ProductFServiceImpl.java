...
@Service
public class ProductFServiceImpl extends BaseServiceNew<Product, ProductDTO, ProductRepository> implements ProductService {
    ...
    public ProductFServiceImpl(ProductRepository pEntityRepository, ProductDescriptionRepository mvProductDescriptionRepository, ProductVariantService mvProductVariantService, ProductHistoryService mvProductHistoryService, OrderRepository mvOrderRepository, CategoryService mvCategoryService, FileStorageRepository mvFileStorageRepository, ProductDetailRepository mvProductDetailRepository, ModelMapper mvModelMapper, SystemLogService mvSystemLogService, CategoryRepository mvCategoryRepository) {
