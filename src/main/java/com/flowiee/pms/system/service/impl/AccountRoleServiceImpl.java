...
import com.flowiee.pms.system.model.ModuleModel;
...
import com.flowiee.pms.system.repository.AccountRoleRepository;
...
public class AccountRoleServiceImpl implements RoleService {
    ...
    public String updatePermission(Account pAccount, List<ActionModel> pActionModelList) {
        ...
        systemLogService.writeLogUpdate(ACTION.SYS_ROLE_U, MasterObject.AccountRole, lvLogTitle, lvLogContent);
